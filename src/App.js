	...
	return (
		<div>
				...
				<div>
					<Code
						...
						prop={[
							...
							{ name: 'value', val: 80 },
							{ name: 'max', val: 200 },
							{ name: 'format', val: '{label: "$", insertAfter: false}' },
							{ name: 'steps', val: 3 },
							{ name: 'size', val: 'small' },
							{ name: 'height', val: 180 },
						]}
			...
			<div className="height-40vh flex flex--row flex--center has-scroll">
				<Thermometer theme={'light'} value={80} max={100} steps={3} size={'small'} height={180} />
				<Thermometer theme={'light'} value={15} max={200} steps={4} size={'normal'} height={180} />
				<Thermometer theme={'light'} value={150} max={300} steps={5} size={'large'} height={180} />
			</div>
			<div className="height-40vh bgcolor-gray-2 flex flex--row flex--center has-scroll">
				<Thermometer theme={'dark'} value={75} max={100} format={{label: '$', insertAfter: false}} steps={3} size={'small'} height={180} />
				<Thermometer theme={'dark'} value={45} max={200} format={{label: '$', insertAfter: false}} steps={4} size={'normal'} height={180} />
				<Thermometer theme={'dark'} value={210} max={300} format={{label: '$', insertAfter: false}} steps={5} size={'large'} height={180} />
			</div>
					...
					<table className="table bottom-gap">
						...
						<tbody>
							...
							<tr>
								<td>format</td>
								<td>object</td>
								<td>label: "%"<br />insertAfter: true</td>
